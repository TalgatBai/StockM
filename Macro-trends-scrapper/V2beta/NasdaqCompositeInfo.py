...
def check_ma_3_ma_7_changes(ma_3_change, ma_7_change, market_notes):
...
def check_ma_3_ma_7_differences(ma_3, ma_7, market_notes):
    if not ma_3 > ma_7:
        market_notes.append('MA(3) <= MA(7)')
...
def is_market_in_a_buy_situation(stock):
    ...
    check_ma_3_ma_7_differences(current_ma_3, current_ma_7, market_notes)
    ...
    check_ma_3_ma_7_changes(current_ma_3_percentage_change, current_ma_7_percentage_change, market_notes)
